...
const list: MetricDefinition[] = [
  ...
  def("humidity", "Влажность", "%", 0, GREEN, 104),
  ...
  // Электрика
  def("battery", "Батарея", "V", 2, GREY, 116),
  ...
  def("percentage", "Процент", "%", 0, GREEN, 120),
  ...
  def("direction", "Направление", "°", 0, ACCENT, 132),
  ...
  def("solar_panel_voltage", "Напряжение солнечной панели", "В", 2, WARM, 116),
  def("soil_moisture", "Влажность почвы", "%", 0, GREEN, 120),
