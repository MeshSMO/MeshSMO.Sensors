        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              <SheetTitle>{translate("common.accessibility.sidebar")}</SheetTitle>
              <SheetDescription>{translate("common.accessibility.mobileSidebar")}</SheetDescription>
            </SheetHeader>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <PanelLeft />
      <span className="sr-only">{translate("common.accessibility.toggleSidebar")}</span>
    </Button>
  );
});
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        data-sidebar="rail"
        aria-label={translate("common.accessibility.toggleSidebar")}
        tabIndex={-1}
        onClick={toggleSidebar}
        title={translate("common.accessibility.toggleSidebar")}
        className={cn(
